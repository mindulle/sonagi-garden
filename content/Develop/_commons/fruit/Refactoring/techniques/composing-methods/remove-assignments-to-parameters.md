...
The reasons for this refactoring are the same as for[[split-temporary-variable|Split Temporary Variable]], but in this case we're dealing
...
- This refactoring helps to extract [[extract-method|repetitive code to separate methods]].
