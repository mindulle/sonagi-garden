...
<!-- BROKEN IMAGE: ![an svg of a clock](math/example_clock.svg) -->
...
<!-- BROKEN IMAGE: ![Outside-in feedback loops in TDD](TDD-outside-in.jpg) -->
...
<!-- BROKEN IMAGE: ![picture of the unit circle](math/images/unit_circle.png) -->
...
<!-- BROKEN IMAGE: ![picture of the unit circle with a point defined on the circumference](math/images/unit_circle_coords.png) -->
...
<!-- BROKEN IMAGE: ![picture of the unit circle with the x and y elements of a ray defined as cos(a) and sin(a) respectively, where a is the angle made by the ray with the x axis](math/images/unit_circle_params.png) -->
...
<!-- BROKEN IMAGE: ![unit circle ray defined from by angle from y axis](math/images/unit_circle_12_oclock.png) -->
...
<!-- BROKEN IMAGE: ![a clock with only a second hand](math/v6/clockface/clockface/clock.svg) -->
...
<!-- BROKEN IMAGE: ![a clock with second and minute hands](math/v9/clockface/clockface/clock.svg) -->
...
<!-- BROKEN IMAGE: ![a clock](math/v12/clockface/clockface/clock.svg) -->
