...
Of course, you can apply this approach to other UI elements as well. However, with each new factory method you add to the `Dialog`, you get closer to the [[Develop/_commons/tree/Design Patterns/catalog/creational/abstract-factory|Abstract Factory]] pattern. Fear not, we'll talk about this pattern later.
...
- You can use [[Develop/_commons/tree/Design Patterns/catalog/creational/factory-method|Factory Method]] along with [[Develop/_commons/tree/Design Patterns/catalog/behavioral/iterator|Iterator]] to let collection
