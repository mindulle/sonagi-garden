...
application's state because some of it can be private. This problem can be mitigated with the [[Develop/_commons/tree/Design Patterns/catalog/behavioral/memento|Memento]] pattern.
...
- Handlers in [[Develop/_commons/tree/Design Patterns/catalog/behavioral/chain-of-responsibility|Chain Of Responsibility]] can be implemented as [[Develop/_commons/tree/Design Patterns/catalog/behavioral/command|Commands]]. In this case, you can execute a lot of different operations over the same context object, represented by a request.
...
- [[Develop/_commons/tree/Design Patterns/catalog/creational/prototype|Prototype]] can help when you need to save copies of [[Develop/_commons/tree/Design Patterns/catalog/behavioral/command|Commands]] into history.
