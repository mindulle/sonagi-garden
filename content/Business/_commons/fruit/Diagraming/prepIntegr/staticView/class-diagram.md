...
<figure class="image">
<img src="/files/sm/images/uml/img_221.jpg" />
<figcaption>Figure 5.19 Class diagram for a business object</figcaption>
</figure>

For a more detailed discussion of class modeling, see *[Structural
View](/uml/modeling-it-systems/structural-view)*. Below, we will only
explain the specifics of the system integration model.

### Class

A class in the class diagram (Figure 5.19) of the system integration
model represents a coherent set of information, which is contained in a
business object:

<figure class="image">
<img src="/files/sm/images/uml/img_222.jpg" />
</figure>

## Reading Class Diagrams

Reading class diagrams of business objects is no different from reading
class diagrams of IT systems. For this see *[Class
...
.fa-arrow-right}](/uml/modeling-for-system-integration/the-static-view/constructing-class-diagrams){.btn
...
View](/uml/modeling-for-system-integration/the-static-view/elements-of-the-view){.btn
