...
<figure class="image">
<img src="/files/sm/images/uml/img_220.jpg" />
<figcaption>Figure 5.18 Static view</figcaption>
</figure>

For the illustration of business objects in the static view of the
system integration model, we only use the class diagram, as illustrated
in Figure 5.18.
...
[Class Diagram []{.fa
.fa-arrow-right}](/uml/modeling-for-system-integration/the-static-view/class-diagram){.btn
...
[[]{.fa .fa-arrow-left} The Static
View](/uml/modeling-for-system-integration/the-static-view){.btn
