...
# The Elements of the View {#the-elements-of-the-view .title}




<figure class="image">
<img src="/files/sm/images/uml/img_146.jpg" />
<figcaption>Figure 4.46 Behavioral view</figcaption>
</figure>

The behavioral view, illustrated in Figure 4.46, consists of many
statechart diagrams, each of which shows the behavior of an individual
object. Therefore, all the statechart diagrams combined show the
behavior of all the objects of the IT system. However, in practice, most
often not all statechart diagrams are constructed but only those that:
...
[Statechart Diagram []{.fa
.fa-arrow-right}](/uml/modeling-it-systems/the-behavioral-view/statechart-diagram){.btn
...
[[]{.fa .fa-arrow-left} The Life of an
Object](/uml/modeling-it-systems/the-behavioral-view/the-life-of-an-object){.btn
...
# The Elements of the View {#the-elements-of-the-view-1 .title}
