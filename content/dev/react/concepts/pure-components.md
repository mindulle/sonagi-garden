...
date: 2025-10-28
tags: [react, concept, javascript, rendering, state, props, component]
category: dev
description: "Pure components re-render only when the props passed to the component changes. For example, if you have a pure child component inside a parent compone..."
---
